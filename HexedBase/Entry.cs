...
namespace HexedBase
{
    public class Entry : HexedCheat // Define the Main Class for the Loader
    {
        public override void OnLoad()
        {
            ...
            MonoManager.OnApplicationQuit(typeof(VRCApplication).GetMethod(nameof(VRCApplication.OnApplicationQuit))); // Optional Hook to enable the OnApplicationQuit callback
